...
function getCountry(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default("https://restcountries.com/v2/name/" + name)];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    return [2 /*return*/, {
...
function getRegionCountries(regionalbloc) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default("https://restcountries.com/v2/regionalbloc/" + regionalbloc)];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    countries = [];
...
function getRegionCapitals(capital) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default("https://restcountries.com/v2/regionalbloc/" + capital)];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    console.log("getReigonCapitals: " + data);
                    capitals = [];
                    for (i = 0; i < data.length; i++) {
